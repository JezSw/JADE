...
import numpy as np
import os
import jadevv.atlas as at
import shutil
import math

from jadevv.output import BenchmarkOutput
from jadevv.output import MCNPoutput
from tqdm import tqdm
from jadevv.status import EXP_TAG
from jadevv.plotter import Plotter
from scipy.interpolate import interp1d
from abc import abstractmethod
from jadevv.inputfile import D1S_Input
import re
...
class ExperimentalOutput(BenchmarkOutput):
    ...
    def build_atlas(self):
        ...
        template = os.path.join(self.code_path, 'Code', 'jadevv', 'templates',
                                'AtlasTemplate.docx')
